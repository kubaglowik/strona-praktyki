...
use Timber\Timber;
use Kodefix\Kuba\RestApi;
use Kodefix\Kuba\Multilang;
...
class Theme
{
  ...
  {
    $cssDate = date('ymd-Gis', filemtime(get_template_directory() . '/dist/styles/style.min.css'));
    wp_register_style('kfx-style', get_template_directory_uri() . '/dist/styles/style.min.css', array(), $cssDate, 'all');
    ...
    $jsDate = date('ymd-Gis', filemtime(get_template_directory() . '/dist/scripts/script.min.js'));
    wp_enqueue_script('kfx-theme-script', get_template_directory_uri() . '/dist/scripts/script.min.js', array(), $jsDate, true);
