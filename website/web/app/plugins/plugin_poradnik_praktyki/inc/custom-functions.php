 ...
 */
function aquila_features_get_template( string $template, array $variables = array(), bool $echo = false ) {

	$template_file = sprintf( '%1$s/templates/%2$s.php', plugin_praktyki_plugin_path, $template );
